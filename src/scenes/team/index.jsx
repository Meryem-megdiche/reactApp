...
const Team = () => {
  ...
  const handleButtonClick = async (row) => {
    ...
    try {
      const response = await axios.get(`https://nodeapp-4c68.onrender.com/api/config/isConfigured/${row.id}`);
  ...
  const handleButton2Click = async (row) => {
    try {
      ...
      await axios.delete(`https://nodeapp-4c68.onrender.com/equip/${row.id}`);
      ...
      try {
        const updatedData = await axios.get("https://nodeapp-4c68.onrender.com/equip");
  ...
  const handlePingButtonClick = async (row) => {
    ...
    try {
      const response = await axios.post(`https://nodeapp-4c68.onrender.com/pingtest/manual`, { ip: equipIp, equipId });
