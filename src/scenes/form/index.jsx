...
const Form = () => {
  ...
  const handleAddUser = async (values) => {
    try {
      ...
      const response = await axios.post('https://nodeapp-4c68.onrender.com/user/users', newUser);
...
const checkoutSchema = yup.object().shape({
  ...
  email: yup.string() .email("Veuillez entrer une adresse e-mail valide").required("required"),
